...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (assetRepository.count() == 0) {
            ...
            Asset a5 = new Asset();
            a5.setAssetName("Cloud-Kubernetes-Node-01");
            a5.setAssetType("Cloud Server");
            a5.setDescription("Primary Kubernetes worker node hosting cloud infrastructure services");
            a5.setManufacturer("AWS EC2");
            a5.setModel("t3.xlarge");
            a5.setSerialNumber("SN-AWS-66701");
            a5.setAssetTag("AST-CLOUD-505");
            a5.setDeviceType("Cloud Instance");
            a5.setOwner("DevOps Team");
            a5.setDepartment("Cloud Architecture");
            a5.setAssignedDepartment("Cloud Infrastructure");
            a5.setAssignedUser("DevOps Lead");
            a5.setAssignedBy("Cloud Admin");
            a5.setAssignmentStatus("Assigned");
            a5.setAssignedDate(LocalDate.now().minusMonths(1));
            a5.setLocation("AWS us-east-1a");
            a5.setHostname("k8s-node-alpha.cloud.internal");
            a5.setIpAddress("10.0.4.15");
            a5.setMacAddress("02:42:AC:11:00:02");
            a5.setGateway("10.0.4.1");
            a5.setSubnetMask("255.255.240.0");
            a5.setDnsServer("10.0.0.2");
            a5.setOperatingSystem("Debian GNU/Linux");
            a5.setOsVersion("12");
            a5.setArchitecture("x86_64");
            a5.setProcessor("AMD EPYC 7571 @ 2.20GHz");
            a5.setCpuCores(4);
            a5.setCpuUsage(75);
            a5.setMemoryUsage(82);
            a5.setDiskUsage(60);
            a5.setNetworkUsage(50);
            a5.setGpuUsage(0);
            a5.setStatus("ACTIVE");
            a5.setHealth("Warning");
            a5.setRiskScore(42);
            a5.setAvailability(99.85);
            a5.setVulnerabilityCount(3);
            a5.setIncidentCount(1);
            a5.setPatchLevel("Update Available");
            a5.setDiscoveredBy("Cloud Watcher Agent");
            a5.setScanStatus("Completed");
            a5.setScanDuration("40s");

            Asset a6 = new Asset();
            a6.setAssetName("AWS-Production-S3-Storage");
            a6.setAssetType("Cloud Storage");
            a6.setDescription("Encrypted cloud storage bucket for audit logs and backup archives");
            a6.setManufacturer("Amazon Web Services");
            a6.setModel("AWS S3 Standard");
            a6.setSerialNumber("SN-AWS-S3-8821");
            a6.setAssetTag("AST-STORE-606");
            a6.setDeviceType("Object Storage");
            a6.setOwner("Cloud Operations");
            a6.setDepartment("Cloud Architecture");
            a6.setAssignedDepartment("DevOps");
            a6.setAssignedUser("SecOps");
            a6.setAssignedBy("System");
            a6.setAssignmentStatus("Assigned");
            a6.setAssignedDate(LocalDate.now().minusMonths(4));
            a6.setLocation("AWS us-east-2");
            a6.setHostname("s3-prod-vault.aws.internal");
            a6.setIpAddress("10.0.12.88");
            a6.setMacAddress("00:00:00:00:00:00");
            a6.setOperatingSystem("AWS S3");
            a6.setStatus("ACTIVE");
            a6.setHealth("Healthy");
            a6.setRiskScore(3);
            a6.setAvailability(99.99);

            Asset a7 = new Asset();
            a7.setAssetName("Azure-AD-Identity-Server");
            a7.setAssetType("Identity Provider");
            a7.setDescription("Primary Active Directory identity & access management authentication server");
            a7.setManufacturer("Microsoft Azure");
            a7.setModel("Standard_D4s_v5");
            a7.setSerialNumber("SN-MSFT-AZ-9901");
            a7.setAssetTag("AST-IAM-707");
            a7.setDeviceType("Directory Server");
            a7.setOwner("IAM Security Team");
            a7.setDepartment("Cyber Security");
            a7.setAssignedDepartment("IAM");
            a7.setAssignedUser("Identity Admin");
            a7.setAssignedBy("CISO");
            a7.setAssignmentStatus("Assigned");
            a7.setAssignedDate(LocalDate.now().minusMonths(5));
            a7.setLocation("Azure East US 2");
            a7.setHostname("idp-azure-ad.company.com");
            a7.setIpAddress("10.0.8.102");
            a7.setOperatingSystem("Windows Server 2022");
            a7.setStatus("ACTIVE");
            a7.setHealth("Healthy");
            a7.setRiskScore(9);
            a7.setAvailability(99.99);

            Asset a8 = new Asset();
            a8.setAssetName("SIEM-Log-Collector-01");
            a8.setAssetType("Security Appliance");
            a8.setDescription("Centralized syslog and telemetry log collector for SIEM threat analysis");
            a8.setManufacturer("Dell Technologies");
            a8.setModel("PowerEdge R650");
            a8.setSerialNumber("SN-DELL-SEC-441");
            a8.setAssetTag("AST-SOC-808");
            a8.setDeviceType("Log Collector");
            a8.setOwner("SecOps SOC Team");
            a8.setDepartment("Cyber Security");
            a8.setAssignedDepartment("SOC");
            a8.setAssignedUser("Analyst Lead");
            a8.setAssignedBy("SOC Manager");
            a8.setAssignmentStatus("Assigned");
            a8.setAssignedDate(LocalDate.now().minusMonths(2));
            a8.setLocation("Data Center B - Rack 02");
            a8.setHostname("siem-collector-01.sec.internal");
            a8.setIpAddress("192.168.1.50");
            a8.setOperatingSystem("Red Hat Enterprise Linux");
            a8.setStatus("ACTIVE");
            a8.setHealth("Warning");
            a8.setRiskScore(35);
            a8.setAvailability(99.90);

            Asset a9 = new Asset();
            a9.setAssetName("Staging-API-Gateway");
            a9.setAssetType("API Gateway");
            a9.setDescription("Staging environment reverse proxy and API rate-limiting gateway");
            a9.setManufacturer("Kong Inc");
            a9.setModel("Kong Enterprise Gateway");
            a9.setSerialNumber("SN-KONG-GW-112");
            a9.setAssetTag("AST-GW-909");
            a9.setDeviceType("API Proxy");
            a9.setOwner("DevOps Team");
            a9.setDepartment("Software Engineering");
            a9.setAssignedDepartment("QA & Staging");
            a9.setAssignedUser("Staging Lead");
            a9.setAssignedBy("DevOps Manager");
            a9.setAssignmentStatus("Unassigned");
            a9.setAssignedDate(LocalDate.now().minusMonths(1));
            a9.setLocation("Data Center A - Rack 01");
            a9.setHostname("api-staging-gw.company.local");
            a9.setIpAddress("192.168.1.15");
            a9.setOperatingSystem("Alpine Linux");
            a9.setStatus("INACTIVE");
            a9.setHealth("Healthy");
            a9.setRiskScore(18);
            a9.setAvailability(99.50);

            assetRepository.saveAll(List.of(a1, a2, a3, a4, a5, a6, a7, a8, a9));
            System.out.println(">>> 9 Realistic Enterprise Security Assets saved successfully!");
        }
    }
}
